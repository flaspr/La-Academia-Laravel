                ...
                <form class="row g-3 was-validated mt-1" action="{{ route('contacto.send') }}" method="POST">
                    ...
                    <div class="col-lg-6 row ">
                        ...
                        <div class="containerRelative px-0  col-12 col-md-12 my-4 mx-1">
                            <input placeholder=" " type="text" name="nameC" value="{{old('nameC')}}" class="form-Dani" id="nameC" required>
                            <span class="barra  "></span>
                            <label for="nameC" class="form-label" onclick="document.getElementById('nameC').focus()">Nombre</label>
                        </div>
                        <div class=" containerRelative px-0 col-12 col-md-12 my-4 mx-1">
                            <input placeholder=" " type="text" name="subnameC" value="{{old('subnameC')}}" class="form-Dani" id="subnameC" required>
                            <span class="barra "></span>
                            <label for="subnameC" class="form-label" onclick="document.getElementById('subnameC').focus()">Apellidos</label>
                        </div>
                        <div class="containerRelative px-0 col-12 col-md-12 my-4 mx-1">
                            <input placeholder=" " type="email" name="emailC" value="{{old('emailC')}}" class="form-Dani" id="emailC" required>
                            <span class="barra "></span>
                         <label for="emailC" class="form-label" onclick="document.getElementById('emailC').focus()">Correo electrónico</label>
                        </div>
                        <div class="col-md-12 containerRelative mx-1">
                            <textarea class="form-Dani col-12" placeholder=" "  name="mensajeC" id="mensajeC" rows="4"required> {{old('mensajeC')}} </textarea>
                            <span class="barra"></span>
                            <label for="validationTextarea" onclick="document.getElementById('mensajeC').focus()" class="form-label">Mensaje</label>
                        </div>
